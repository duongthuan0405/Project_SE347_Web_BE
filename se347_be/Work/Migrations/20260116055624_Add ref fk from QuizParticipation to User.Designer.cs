...
namespace se347_be.Migrations
{
    ...
    [Migration("20260116055624_Add ref fk from QuizParticipation to User")]
    partial class AddreffkfromQuizParticipationtoUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("se347_be.Work.Database.Entities.QuizParticipation", b =>
                {
                    ...
                    b.HasOne("se347_be.Work.Database.Entity.AppUser", "User")
                        .WithMany("QuizzesParticipated")
            ...
            modelBuilder.Entity("se347_be.Work.Database.Entity.AppUser", b =>
                {
                    ...
                    b.Navigation("QuizzesParticipated");
                });
